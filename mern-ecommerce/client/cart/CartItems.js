    ...
    return (<Card className={classes.card}>
      ...
      {this.state.cartItems.length>0 ? (<span>
            ...
            return <span key={i}><Card className={classes.cart}>
              ...
              <div className={classes.details}>
                <CardContent className={classes.content}>
                  ...
                  <div>
                    <Typography type="subheading" component="h3" className={classes.price} color="primary">R {item.product.price}</Typography>
                    <span className={classes.itemTotal}>R{item.product.price * item.quantity}</span>
        ...
        <div className={classes.checkout}>
          <span className={classes.total}>Total: R{this.getTotal()}</span>
